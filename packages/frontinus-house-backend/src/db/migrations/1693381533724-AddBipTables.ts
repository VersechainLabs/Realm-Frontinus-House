...
export class AddBipTables1693381533724 implements MigrationInterface {
    name = 'AddBipTables1693381533724'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "bip_vote" ("id" SERIAL NOT NULL, "direction" integer NOT NULL DEFAULT '1', "address" character varying NOT NULL, "bipOptionId" integer NOT NULL, "weight" integer NOT NULL DEFAULT '0', "actualWeight" integer NOT NULL DEFAULT '0', "blockHeight" integer, "delegateId" integer, "delegateAddress" character varying, "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "deletedDate" TIMESTAMP, CONSTRAINT "PK_f318d813b42faf6906a1f8127b9" PRIMARY KEY ("id"))`);
