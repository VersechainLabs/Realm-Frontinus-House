import CommunityCard from '../CommunityCardV2';
import classes from './CommunityCardGridV2.module.css';
...
const CommunityCardGridV2 = ({ input, communities, isLoading }: CommunityCardGridProps) => {
...
export default CommunityCardGridV2;
